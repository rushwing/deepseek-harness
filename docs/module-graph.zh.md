...
flowchart TD
  ...
  subgraph group_experimental["packages/experimental"]
    ...
    pkg_experimental_llm_claude_code["experimental-llm-claude-code"]
    pkg_experimental_llm_codex["experimental-llm-codex"]
  ...
  subgraph group_product_runtime["packages/product-runtime"]
    pkg_claude_agent_sdk["claude-agent-sdk"]
  ...
  pkg_claude_agent_sdk --> pkg_subprocess
  ...
  pkg_experimental_llm_claude_code --> pkg_agent
  pkg_experimental_llm_claude_code --> pkg_llm
  pkg_experimental_llm_claude_code --> pkg_session
  pkg_experimental_llm_claude_code --> pkg_session_projection
  pkg_experimental_llm_claude_code --> pkg_subprocess
  pkg_experimental_llm_claude_code --> pkg_timeout
  pkg_experimental_llm_claude_code --> pkg_user_approval
  pkg_experimental_llm_claude_code --> pkg_user_questions
  pkg_experimental_llm_codex --> pkg_agent
  pkg_experimental_llm_codex --> pkg_llm
  pkg_experimental_llm_codex --> pkg_session
  pkg_experimental_llm_codex --> pkg_session_projection
  pkg_experimental_llm_codex --> pkg_subprocess
  pkg_experimental_llm_codex --> pkg_timeout
  pkg_experimental_llm_codex --> pkg_user_approval
  pkg_experimental_llm_codex --> pkg_user_questions
  ...
  pkg_experimental_llm_product_backend --> pkg_timeout
...
| [`claude-agent-sdk`](../packages/product-runtime/claude-agent-sdk) | `product-runtime` | [`subprocess`](../packages/subprocess/subprocess) |
...
| [`experimental-llm-claude-code`](../packages/experimental/llm-claude-code) | `experimental` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout), [`user-approval`](../packages/interaction/user-approval), [`user-questions`](../packages/interaction/user-questions) |
| [`experimental-llm-codex`](../packages/experimental/llm-codex) | `experimental` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`subprocess`](../packages/subprocess/subprocess), [`timeout`](../packages/util/timeout), [`user-approval`](../packages/interaction/user-approval), [`user-questions`](../packages/interaction/user-questions) |
| [`experimental-llm-product-backend`](../packages/experimental/llm-product-backend) | `experimental` | [`agent`](../packages/core/agent), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection), [`timeout`](../packages/util/timeout), [`user-approval`](../packages/interaction/user-approval), [`user-questions`](../packages/interaction/user-questions) |
