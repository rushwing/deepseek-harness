...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `answer` | 必需 | [`union (2 variants)`](#persistence-type-sha256-799231ac91869a6695666505343003905638e1b4d11349bff953d4dbfe3191ba) |
| `options` | 必需 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `phase` | 必需 | [`union (3 variants)`](#persistence-type-sha256-3f3787d6b055fb74dbbe2816c591adc501c7f044cf55bdaa694fa20c05611e21) |
| `reqId` | 必需 | `string` |
| `state` | 必需 | `string` |
| `version` | 必需 | `1` |
...
来源：[`packages/experimental/lifecycle-orchestrator/src/events.ts:8`](../packages/experimental/lifecycle-orchestrator/src/events.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `ruleCounts` | 必需 | [`{}`](#persistence-type-sha256-51418d209d3ad7c6f8a841c0927ca89d93d3780afbcc83500045bcdaf5d25b7e) |
| `scope` | 必需 | `string` |
| `version` | 必需 | `1` |
...
来源：[`packages/experimental/lifecycle-orchestrator/src/events.ts:18`](../packages/experimental/lifecycle-orchestrator/src/events.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `actorUid` | 必需 | `string` |
| `eventName` | 可选 | `string` |
| `files` | 必需 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `from` | 必需 | `string` |
| `id` | 必需 | `string` |
| `ownerAfter` | 必需 | `string` |
| `ownerBefore` | 必需 | `string` |
| `reqId` | 必需 | `string` |
| `reviewRound` | 必需 | [`OptionalSessionSeq`](#persistence-type-sha256-3bd652ebfa8726b3ce3937a4f1bd2759e02f86b3a08a20f9e41a8513656fbc5f) |
| `to` | 必需 | `string` |
| `version` | 必需 | `1` |
...
来源：[`packages/experimental/llm-product-backend/src/binding.ts:13`](../packages/experimental/llm-product-backend/src/binding.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `conversationId` | 必需 | `string` |
| `cwd` | 必需 | `string` |
| `model` | 可选 | `string` |
...
来源：[`packages/experimental/lifecycle-orchestrator/src/events.ts:47`](../packages/experimental/lifecycle-orchestrator/src/events.ts) · [`packages/session/session-title/src/types.ts:20`](../packages/session/session-title/src/types.ts) · [`packages/subagent/tool-subagent/src/model-selection.ts:9`](../packages/subagent/tool-subagent/src/model-selection.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`LifecycleHumanDecisionEvent`](#persistence-type-sha256-bc56c002fd16bd926f7f209d8b34e99763bac5f449e6433b93a4e180f7ed322d) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"lifecycle/human-decision"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`LifecycleLintEvent`](#persistence-type-sha256-98613e41701f6f283bb544293e1e0ecc190faf053a73c99d515eabbabe2f1dbf) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`LifecycleTransitionEvent`](#persistence-type-sha256-90ab8b331721d984cbab576df59c86893354e03fbfebc9d563cb59959e115520) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"lifecycle/transition"` |
