...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  Briefs: 'lifecycle-team.md',
  LifecycleLoad: 'lifecycle-team.md',
  ArtifactGraph: 'lifecycle-team.md',
  LintReport: 'lifecycle-team.md',
  CheckInRequest: 'lifecycle-team.md',
  CheckInResult: 'lifecycle-team.md',
  LegalTransition: 'lifecycle-team.md',
  LifecycleStatus: 'lifecycle-team.md',
  TransitionRequest: 'lifecycle-team.md',
