#!/usr/bin/env node
/** Inspect the public Codex backend composition without invoking the product. */
...
if (configPath === undefined || bundlePatchPath === undefined) {
  throw new Error('llm-codex Loader composition driver requires config and Bundle patch paths')
}

const ctx = await bootProductionProfile({
  binName: 'llm-codex-loader-composition',
  profile: 'headless',
  overlayPaths: [
