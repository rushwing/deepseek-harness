...
| [`lifecycle-team-profile`](lifecycle-team-profile/README.md) | Composes the lifecycle orchestrator and the model fallback over dsh-base as one optional bundle a person switches on | bundle — no ctx key |
